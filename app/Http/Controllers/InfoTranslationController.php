...
class InfoTranslationController extends Controller
{
    ...
    {
        return view('infoTranslations.index');
    }


    public function view($id)
    {
        $organizations = InfoTranslation::getAllOrganizations($id);
        return view('infoTranslations.view',[
    ...
    public function create($id)
    {
        ...
        return view('infoTranslations.InfoTranslationCreate',[
            'langs' => $availableLang,
            'university_id' => $id
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        // return view('translations.InfoTranslationEdit',[
